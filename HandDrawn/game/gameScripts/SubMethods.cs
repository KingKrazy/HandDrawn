function SubClass::onAddToScene( %this )
{
    %this.Sub = 1;
...
function SubClass::onRemove( %this )
{

}

function SubClass::onRespawn( %this, %dAmount, %srcObject )
{
    %this.DisableGravity = false;
}

function SubClass::onLanded( %this, %platformObject )
{
...
function SubClass::onWallCollision( %this, %wall, %normal )
{
