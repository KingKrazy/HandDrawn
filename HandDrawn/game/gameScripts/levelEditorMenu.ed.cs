...
function LevelBuilderMenu::initialize( %this )
{
   ...
   %fileMenu = new PopupMenu()
   {
      ...
      item[6] = "-";
      item[7] = "Save" TAB $cmdCtrl SPC "S" TAB "ToolManager.getLastWindow().setFirstResponder(); LBProjectObj.saveLevel();";
      item[8] = "Save As..." TAB "" TAB "ToolManager.getLastWindow().setFirstResponder(); LBProjectObj.saveLevelAs();";
   ...
   %projectMenu = new PopupMenu()
   {
      ...
      item[10] = "-";
      item[11] = "Reload Project" TAB "" TAB "reloadProject();";
      item[12] = "Open Project Folder" TAB "" TAB "openProjectFolder();";
      item[13] = "-";
      item[14] = "Resources..." TAB $cmdCtrl SPC "R" TAB "Canvas.pushDialog(projectOptionsDlg);";
   };      
   ...
   %helpMenu = new PopupMenu()
   {
      ...
      item[3] = "-";
      item[4] = "GarageGames Community Page" TAB "" TAB "gotoWebpage(\"http://www.garagegames.com/community\");";
      item[5] = "TGB Developer Forums" TAB "" TAB "gotoWebpage(\"http://www.garagegames.com/community/forums/28\");";
      item[6] = "GarageGames News" TAB "" TAB "RSSUpdate::showNews();";
      item[7] = "-";
      item[8] = "About..." TAB "" TAB "TGBInsiderDlg.showAbout();";
   };
