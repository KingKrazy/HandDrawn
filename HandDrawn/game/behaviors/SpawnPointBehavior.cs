...
if ( !isObject( SpawnPointBehavior ) )
{
    ...
    %template.addBehaviorField( TargetObject,     "Spawn this object (uses datablocks)",     OBJECT, "CavemanActorTemplate", t2dSceneObjectDatablock );
    ...
    %template.addBehaviorField( FlipOnSpawn,      "Flip on spawn",   BOOL,   false );
